      ...
      <div className="relative z-20 flex items-center min-h-screen px-4">
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            >
              Top up your phone in a flash. With Jericho, send airtime or data directly from your crypto wallet—instant, reliable, and always at your fingertips. Works with MTN, Glo, Airtel, and 9mobile.
            </motion.p>
          </motion.div>
        </div>
      </div>
