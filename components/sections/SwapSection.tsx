      ...
      <div className="relative z-20 flex items-center min-h-screen px-4">
        <div className="max-w-7xl mx-auto w-full flex justify-end">
          ...
          >
            ...
            <motion.p
              className="text-sm sm:text-base md:text-lg text-white/40 max-w-xl ml-auto font-light leading-relaxed"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: 0.15, ease: "easeOut" }}
            >
              Swap with confidence. Effortlessly exchange your assets in seconds, backed by secure and transparent liquidity. No fuss, no barriers—just pure freedom. Naira-to-crypto swaps available.
            </motion.p>
          </motion.div>
        </div>
      </div>
