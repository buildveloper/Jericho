    ...
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-end min-h-screen pb-20 md:pb-32 px-4">
        ...
        >
          ...
          >
            Store, swap and protect digital assets across Bitcoin, Ethereum,
            Solana, Base, Polygon, and BNB Chain — all from one unified,
          ...
          >
            <button className="glass-panel px-8 py-3.5 text-sm font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-300 rounded-xl cursor-pointer" aria-label="Get early access to Jericho Wallet">
              Get Early Access
            </button>
            <button className="px-8 py-3.5 text-sm font-medium text-white/50 hover:text-white/80 transition-colors rounded-xl cursor-pointer" aria-label="Explore the ecosystem">
              Explore Ecosystem →
            </button>
          </motion.div>
          ...
          >
            {["SOC 2 Compliant", "$100M+ Secured", "Multi-Chain"].map(
              (signal) => (
                <span
                  key={signal}
